      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-[#0f1a14] to-[#1a2e1f] px-8 pt-8 pb-6">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-bold text-[#25D366] uppercase tracking-widest">Get Early Access</span>
          </div>
          <h2 className="text-2xl font-bold text-white leading-tight">
            Start automating your<br />business on WhatsApp
          </h2>
          <p className="text-white/60 text-sm mt-2">Fill in your details and we'll reach out within 24 hours.</p>
        </div>
          ...
          {submitted ? (
            <div className="text-center py-6">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                Thanks for your interest. We&apos;ll reach out to you at <span className="font-semibold text-gray-700">{form.number || "your number"}</span> within 24 hours.
              </p>
              <Button
                onClick={handleClose}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell us briefly about your business and how you currently manage your team..."
                  rows={3}
